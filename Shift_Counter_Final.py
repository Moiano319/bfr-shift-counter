...
st.caption("Any shifts before spm reaches this threshold will not be counted. This eliminates any manual shifting that may occur before the engine starts.")
